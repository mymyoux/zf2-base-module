...
class Google extends AbstractMigration
{
    /**
     * Change Method.
     *
   ...
   public  $actions = ['delete'=> 'CASCADE', 'update'=> 'CASCADE'];
    ...
    {
          $this->table('user_network_google', ['id' => true])
            ->addColumn('id_google', 'string', ['limit' => 200, 'null'=>false])
            ->addColumn('id_player', 'string', ['limit' => 200, 'null'=>false])
            ->addColumn('id_user', 'integer', ['limit' => 11, 'signed' => false, 'null'=>false])
            ->addColumn('id_app', 'integer', ['limit' => 11, 'signed' => false, 'null'=>false])
            ...
            ->addColumn('token_type', 'string', ['limit' => 200, 'null'=>true])
            ->addColumn('id_token', 'string', ['limit' => 2000, 'null'=>true])
            ->addColumn('expires', 'integer', ['null'=>true,'limit'=>13])
           ...
           ->addIndex(['id_user','id_app'], ['unique'=>True])
           ->addIndex('id_google')
           ->addForeignKey('id_user', 'user', 'id_user', $this->actions)
           ->addForeignKey('id_app', 'app', 'id_app', $this->actions)
            ->create();

            $this->table('user_api')
            ->addColumn('google','integer', ['limit'=>1,'signed'=>false,'null'=>false,'default'=>0])
            ->update();
