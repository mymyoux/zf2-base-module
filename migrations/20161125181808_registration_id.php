...
class RegistrationId extends AbstractMigration
{
    /**
     * Change Method.
     *
   ...
   public  $actions = ['delete'=> 'CASCADE', 'update'=> 'CASCADE'];
    ...
    {
     $this->table('app_user_registration', ['id' => false, 'primary_key' => 'id_user_registration'])
            ->addColumn('id_user_registration', 'integer', ['limit' => 11, 'signed' => false,'identity'=>true])
            ->addColumn('id_app_user', 'integer', ['limit' => 11, 'signed' => false,'null'=>false])
            ->addColumn('registration_id', 'string', ['limit' => 200,  'null'=>false])
            ->addColumn('valid', 'integer', ['limit' => 1,  'null'=>false,'default'=>1,'signed'=>False])
            ...
            ->addIndex('registration_id')
           ->addForeignKey('id_app_user', 'app_user', 'id_app_user', $this->actions)
            ->create();

      $this->table('push', ['id' => false, 'primary_key' => 'id_push'])
       ->addColumn('id_push', 'integer', ['limit' => 11, 'signed' => false,'identity'=>true])
        ->addColumn('id_app_user', 'integer', ['limit' => 11, 'signed' => false,'null'=>false])
        ->addColumn('id_user_registration', 'integer', ['limit' => 11, 'signed' => false,'null'=>false])
         ->addColumn('content', 'string', [ 'null' => false,'limit'=> MysqlAdapter::TEXT_LONG])
        ->addColumn('multicast_id', 'string', ['limit' => 200, 'null'=>true])
        ->addColumn('message_id', 'string', ['limit' => 200, 'null'=>true])
        ->addColumn('error', 'string', ['limit' => 1000, 'null'=>true])
        ->addColumn('created_time', 'timestamp', ['null' => true])
        ->addColumn('updated_time', 'timestamp', ['null' => true, 'default' => 'CURRENT_TIMESTAMP', 'update' => 'CURRENT_TIMESTAMP'])
         ->addForeignKey('id_app_user', 'app_user', 'id_app_user', $this->actions)
          ->addForeignKey('id_user_registration', 'app_user_registration', 'id_user_registration', $this->actions)
        ->create();

        $this->addPrecision('push');
    }
