...
class NotificaitonUuid extends AbstractMigration
{
    /**
     * Change Method.
     *
   ...
   public  $actions = ['delete'=> 'CASCADE', 'update'=> 'CASCADE'];
    ...
    {
      $this->table("app_user_registration")
      ->addColumn('uuid','string',['limit'=>200, 'null'=>True,'after'=>'id_app_user'])
      ->addIndex('uuid', ['unique'=>False])
      ->update();
    }
