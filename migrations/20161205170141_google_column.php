...
class GoogleColumn extends AbstractMigration
{
    /**
     * Change Method.
     *
   ...
   public  $actions = ['delete'=> 'CASCADE', 'update'=> 'CASCADE'];
    ...
    {
      $this->table('user_network_google')
      ->addColumn('created','integer',['limit'=>13, 'signed'=>false,'null'=>True])
      ->addColumn('expires_in','integer',['limit'=>10, 'signed'=>false,'null'=>True])
      ->update();
