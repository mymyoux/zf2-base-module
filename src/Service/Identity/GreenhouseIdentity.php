...
class GreenhouseIdentity extends APIIdentity
{
    /**
    ...
    {
        $this->api = $this->sm->get("APIManager")->get("greenhouse");// new LinkedIn($this->api_key, $this->secret_key);
    }
    ...
    {
        return array_merge(parent::_getDefaultColumns(), ['access_token']);
    }
}
